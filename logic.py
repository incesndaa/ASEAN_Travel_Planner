...
class AnggaranPerjalanan:
    def __init__(self, biayaTransportasi, biayaAkomodasi, biayaMakanan, durasiPerjalanan):
        self.biayaTransportasi = biayaTransportasi
        self.biayaAkomodasi = biayaAkomodasi
        self.biayaMakanan = biayaMakanan
        self.durasiPerjalanan = durasiPerjalanan

    def hitungAnggaran(self):
        totalBiayaHarian = self.biayaTransportasi + self.biayaAkomodasi + self.biayaMakanan
        return totalBiayaHarian * self.durasiPerjalanan
